...
public class PassInfos {
    ...
    private static final String PROPERTIES_FILE_PATH =System.getProperty("user.home")+"\\git\\ITQA-MultiAppFramework\\MultiAppFramework\\src\\main\\java\\com\\DataTables\\Settings.properties"; // Update the path
